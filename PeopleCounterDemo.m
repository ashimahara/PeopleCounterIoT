...
[initialNum,latestDate] = thingSpeakRead(1307050,'ReadKey','L1YU3VXW066O3OZ4');
if dateshift(latestDate,'start','day') < datetime('today')
...
%  data in the channel.
vidObj = webcam('GENERAL WEBCAM','Resolution','640x480');
